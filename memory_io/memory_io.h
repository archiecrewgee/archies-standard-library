...
/**
 * @brief 
 *  Type defining a generic 'write memory block' function. This interface should remain the same regardless of the memory medium.
...
/**
 * @brief 
 *  Type defining a generic 'read memory block' function. This interface should remain the same regardless of the memory medium. 
 *  Non-zero return value is considered a failure
 * @note This function is treated as blocking
 */
...
/**
 * @brief Memory medium instance defining the memory paramters and IO function calls. 
...
typedef const struct {
    ...
    uint8_t * scratch;  // this should be allocated dynamically/statically a location in memory of the same size as a given medium's block
} MemoryIO_Medium_t;
...
/**
 * @brief Writes len bytes from src to the given memory medium
 * 
 * @param medium pointer to memory medium instance
...
/**
 * @brief Reads len bytes from the given memory medium to dst
 * 
 * @param medium pointer to memory medium instance
...
/**
 * @brief Reads len blocks from the given memory medium to dst
 * 
 * @param medium pointer to the memory medium instance
...
/**
 * @brief Writes len blocks from src to the given memory medium
 * 
 * @param medium pointer to memory medium instance
